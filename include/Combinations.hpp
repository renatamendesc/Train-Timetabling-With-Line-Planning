...
public:
    ...
    Combinations(Data &data, int threads, std::string scheduling, int strategy);
...
private:
    ...
    void execute_heuristic_set_of_combinations(Data &data, unsigned long long int start, unsigned long long int end, int thread_id);
